    ...
    <div className="bg-[#f8f9fa] h-screen ">
      <div className=" text-center py-8 ">
        ...
        <p className="text-gray-500 text-lg">
          Get excited—your choice of 80+ weekly options is just a few steps
          away!
        </p>
      </div>
        ...
        <div className="py-4 flex justify-center">
          <div>
            ...
            <div
              ...
              className={`w-[375px]  mb-3 h-[90px] cursor-pointer relative hover:border-[#002c9b]  border-2 rounded-md  ${
            ...
            <div
              ...
              className={`w-[375px]  h-[90px] cursor-pointer relative hover:border-[#002c9b]  border-2 rounded-md  ${
          ...
          <h1 className="text-lg font-bold text-gray-800 ">Servings per meal</h1>
          <div className="w-[225px] h-[43px] flex border   text-center border-gray-400 ">
            <div  onClick={() => handleBtn("1")}
        className={`w-[50%] h-full items-center justify-center flex ${
          selectedbtn === "1" ? 'bg-[#002c9b] text-white text-center transition-colors duration-100' : ''
        }`}>1</div>
            <div onClick={() => handleBtn("2")}
        className={`w-[50%] h-full items-center justify-center flex ${
          selectedbtn === "2" ? 'bg-[#002c9b] text-white transition-colors duration-100' : ''
        }`}>2</div>
          </div>
          ...
          <h1 className="text-lg font-bold text-gray-800 ">Meals per Week</h1>
          <div className="w-[225px] h-[43px] flex border   text-center border-gray-400 ">
            <div  onClick={() => handleMeal("meal1")}
        className={`w-[50%] h-full items-center justify-center flex ${
          meal === "meal1" ? 'bg-[#002c9b] text-white text-center transition-colors duration-100' : ''
        }`}>1</div>
            <div onClick={() => handleMeal("meal2")}
        className={`w-[50%] h-full items-center justify-center flex ${
          meal === "meal2" ? 'bg-[#002c9b] text-white transition-colors duration-100' : ''
        }`}>2</div>
        <div  onClick={() => handleMeal("meal3")}
        className={`w-[50%] h-full items-center justify-center flex ${
          meal === "meal3" ? 'bg-[#002c9b] text-white text-center transition-colors duration-100' : ''
        }`}>3</div>
        <div  onClick={() => handleMeal("meal4")}
        className={`w-[50%] h-full items-center justify-center flex ${
          meal === "meal4" ? 'bg-[#002c9b] text-white text-center transition-colors duration-100' : ''
        }`}>4</div>
          ...
          <h1 className="text-lg font-bold text-left text-gray-900 ">Order Summary</h1>
          ...
          <div className="flex mt-2 justify-between items-center">
            <p className="text-gray-700 font-semibold">First order subtotal </p>
